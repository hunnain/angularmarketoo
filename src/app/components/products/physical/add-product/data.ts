...
export const LabelOptions = (lang) =>  [
  ...
  { id: '#recommendedgifts', text: lang === 'en' ?  "Recommended Gifts":"推薦禮物"  },
  { id: '#customgifts', text: lang === 'en' ?  "Custom Gifts":"訂做禮物"  },
  { id: '#diygifts', text: lang === 'en' ?  "DIY Gifts":"DIY禮物"  },
  { id: '#birthdaygifts', text: lang === 'en' ?  "Birthday Presents":"生日禮物"  },
  { id: '#valentinesgifts', text: lang === 'en' ?  "Valentines Gifts":"情人節禮物"  },
  { id: '#couplegifts', text: lang === 'en' ?  "Couples Gifts":"情侶禮物"  },
  { id: '#anniversarygifts', text: lang === 'en' ?  "Anniversary Gifts":"紀念禮物"  },
  { id: '#mothersdaygifts', text: lang === 'en' ?  "Mother’s Day Gifts":"母親節禮物"  },
  { id: '#fathersdaygifts', text: lang === 'en' ?  "Father’s Day Gifts":"父親節禮物"  },
  { id: '#girlfriendgifts', text: lang === 'en' ?  "Girlfriend Gifts":"女朋友禮物"  },
  { id: '#boyfriendgifts', text: lang === 'en' ?  "Boyfriend Gifts":"男朋友禮物"  },
  { id: '#giftsexchange', text: lang === 'en' ?  "Gifts Exchange":"交換禮物"  },
  { id: '#graduationgifts', text: lang === 'en' ?  "Graduation Gifts":"畢業禮物"  },
  { id: '#weddinggifts', text: lang === 'en' ?  "Wedding Gifts":"結婚禮物"  },
  { id: '#bridalgifts', text: lang === 'en' ?  "Bridal Gifts":"姊妹禮物"  },
  { id: '#christmasgifts', text: lang === 'en' ?  "Christmas Gifts":"聖誕禮物"  },
  { id: '#heartfeltgifts', text: lang === 'en' ?  "Heartfelt Gifts":"心意禮物"  },
  { id: '#bestiegifts', text: lang === 'en' ?  "Bestie Gifts":"閨蜜禮物"  },
  { id: '#coupleoutfits', text: lang === 'en' ?  "Couple Outfits":"情侶裝"  },
  { id: '#parentchildoutfit', text: lang === 'en' ?  "Parent Child Outfit":"親子裝"  },
  ...
  { id: '#environmentalfriendly', text: lang === 'en' ?  "Environmental Friendly":"環保"  },
  { id: '#workshop', text: lang === 'en' ?  "Workshop":"工作坊"  },
  { id: '#extracurricularactivities', text: lang === 'en' ?  "Extracurricular Activities":"興趣班"  },
  { id: '#weekendspots', text: lang === 'en' ?  "Weekend Spots":"週末好去處"  },
  { id: '#parentchildspots', text: lang === 'en' ?  "Parent Child Spots":"親子好去處"  },
  { id: '#couplespots', text: lang === 'en' ?  "Couples Spots":"情侶好去處"  },
  { id: '#datingspots', text: lang === 'en' ?  "Dating Spots":"拍拖好去處"  },
  { id: '#weekendmarkets', text: lang === 'en' ?  "Weekend Markets":"週末市集"  },
  { id: '#hongkongdesigns', text: lang === 'en' ?  "Hong Kong Designs":"香港設計"  },
  { id: '#hongkongbrands', text: lang === 'en' ?  "Hong Kong Brands":"香港品牌"  },
  { id: '#originaldesign', text: lang === 'en' ?  "Original Design":"原創設計" },
];
